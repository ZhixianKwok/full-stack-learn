...
note over browser:the user creates a new note,the browser creates the DOM to store the new note
browser->>server: HTTP POST https://studies.cs.helsinki.fi/exampleapp/new_note_spa
server-->>browser:{"message":"note created"}

```
![sequence diagram of single page app](./single-page-app.png)
